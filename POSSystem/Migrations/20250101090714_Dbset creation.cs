        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UnitofMeasure = table.Column<int>(type: "int", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Code = table.Column<Guid>(type: "uniqueidentifier", maxLength: 20, nullable: false),
                    ...
                    CountryId = table.Column<Guid>(type: "uniqueidentifier", maxLength: 50, nullable: false),
                    City = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Province = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ZipPostalCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VatRegNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
